...
# Pasta padrão para os templates
TEMPLATE_DIR = os.path.join(BASE_DIR, 'templates')

# Pasta padrão para os arquivos static
STATIC_DIR = os.path.join(BASE_DIR, 'static')

# tag para que nosso projeto encontre o .env
load_dotenv(os.path.join(BASE_DIR, ".env")) 

# Diz para Projeto aonde estão nossos aplicativos
...
CORS_ORIGIN_WHITELIST = ['http://localhost',] # Lista.

#SSL and Cookies Vamos deixar configurado tambem. doc: https://docs.djangoproject.com/pt-br/5.1/ref/settings/
if not DEBUG:
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',    # Biblioteca CORS HEARDER https://pypi.org/project/django-cors-headers/
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'requestlogs.middleware.RequestLogsMiddleware', # LOGS doc: https://pypi.org/project/django-requestlogs/
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #Apps
                'apps._base.context_processors.context_social',
            ],
        },
    },
]
